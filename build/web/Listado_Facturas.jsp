...
<html>
    ...
    <center>
        <h1 style="background:#343434;color:#f9faff;width:675px">.:: Listado de Facturas ::.</h1>
        <br>
        <br>
        ...
        <form name="frm_lis_factura" action="Imprimir.jsp" method="post">
            <table border="1" width="50%" class="tg">
                <tr>
                    ...
                    <th class="tg-1vft">
                        <input type="hidden" name="condicion" value="factura1">
                        <input type="hidden" name="nombre_reporte" value="factura_hotel">
